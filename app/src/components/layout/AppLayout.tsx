...
const workflowTabsEnhanced = [
   ...
   { id: 'evaluation' as AppTab, label: '3. Évaluation', desc: 'Notation des élèves', icon: '✏️' },
                     ...
                     return (
                        <div key={tab.id} className="relative group">
                           ...
                           >
                              ...
                              {/* Quick Access Menu Button for Evaluation */}
                              {tab.id === 'evaluation' && (
                                 <button
                                    onClick={(e) => {
                                       e.stopPropagation()
                                    ...
                                    className={`
                                       shrink-0 w-6 h-6 rounded-md flex items-center justify-center text-xs transition-all opacity-0 group-hover:opacity-100
                                       ${isActive
